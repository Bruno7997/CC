...
if(this.Ciclo=="Aberto"){
    ...
    if(Math.round(random(1,2))==1){this.Disposição="Normal"}else{this.Disposição="Ramificada"}
...
for(var t in this.ja){if(this.ja[t]!=undefined){tt+=1}};if(tt==4){this.Q=q+1}
    /*for(var t in this.ja){this.ja[t]=undefined}
QdP+=1;console.log("%c MUDOU", "color: BROWN");if(ee-1>=0){ee=Number(ee-1)}if(ee-1<0){e=e-1;if(e>0){ee=Number(Lc[e][1].length-1)}}
if(e<0){this.Q+=1;console.log("%c PULOU", "color: BROWN")}
if((e>0&&Lc[e][1]==undefined)||ee<0||e>0&&Lc[e][1][ee]==undefined){for(var t in this.ja){this.ja[t]=1}}
console.log(Qdl)*/
...
this.greeting.style('font-size', (50/(message.length/32))+'px')
    ...
    //e=[];ee=[]
    function ProcurarCadeias(e4,ee4,e,ee){
        this.a;this.n;this.rt
        this.e=e;this.ee=ee
        for(var l in Lc[e4][1][ee4][3]){
            this.e.push(Lc[e4][1][ee4][3][l][2]);this.ee.push(Lc[e4][1][ee4][3][l][3])
        for(var G in Lc[this.e[this.e.length-1]][1]){if(Lc[this.e[this.e.length-1]][1][G][2]==this.ee[this.ee.length-1]){
for(var GG in Lc[this.e[this.e.length-1]][1][G][3]){
